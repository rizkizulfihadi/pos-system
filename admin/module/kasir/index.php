...
<div class="main-content">
	...
	<section class="section">
		...
		<div class="section-body">
			<h2 class="section-title">Keranjang Penjualan</h2>
			<?php
			...
			<div class="row">
				<div class="col-sm-4">
					<div class="card card-primary mb-3">
						<div class="card-header bg-primary text-white">
							<h6><i class="fa fa-search"></i> Cari Barang</h6>
						</div>
						<div class="card-body">
							<input type="text" id="cari" class="form-control" name="cari" placeholder="Scan Barcode / Ketik nama produk">
						</div>
					</div>
				</div>
				<div class="col-sm-8">
					<div class="card card-primary mb-3">
						<div class="card-header bg-primary text-white">
							<h6><i class="fa fa-list"></i> Hasil Pencarian</h6>
						</div>
						<div class="card-body">
				...
				<div class="col-sm-12">
					<div class="card card-primary">
						<div class="card-header bg-primary text-white">
							<h6><i class="fa fa-shopping-cart"></i> KASIR</h6>
							<a class="btn btn-danger ml-auto rounded-0" onclick="javascript:return confirm('Apakah anda ingin reset keranjang ?');" href="fungsi/hapus/hapus.php?penjualan=jual">
							...
							<div id="keranjang" class="table-responsive">
								...
								<div id="kasirnya">
									<table class="table table-stripped">
										...
										?>
										<!-- aksi ke table nota -->
										<form method="POST" action="index.php?page=kasir&nota=yes#kasirnya">
											<?php foreach ($hasil_penjualan as $isi) {; ?>
											...
											<tr>
												...
												<td><button class="btn btn-dark"><i class="fa fa-shopping-cart"></i> Bayar</button>
...
<script>
	document.addEventListener('DOMContentLoaded', function() {
		...
		cariInput.addEventListener('input', function() {
			...
			var keyword = cariInput.value;

			xhr.onreadystatechange = function() {
				if (xhr.readyState == 4 && xhr.status == 200) {
					var hasilCari = document.getElementById('hasil_cari');
					var tunggu = document.getElementById('tunggu');
			...
			xhr.open('POST', 'fungsi/edit/edit.php?cari_barang=yes', true);
			xhr.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
			xhr.send('keyword=' + encodeURIComponent(keyword));

			var tunggu = document.getElementById('tunggu');
			tunggu.innerHTML = '<p style="color:green"><blink>tunggu sebentar</blink></p>';
		});
	});
</script>